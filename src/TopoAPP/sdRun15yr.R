...
system(paste('scp -i /home/joel/.ssh/joel.pem ', ' gc3-user@130.60.24.',ipaddress[i],':~/sim/box',nseq[i],'/meanX_snow_depth.mm..txt /home/joel/src/hobbes/results',nresults,'/b',nseq[i],'/',sep=''))
