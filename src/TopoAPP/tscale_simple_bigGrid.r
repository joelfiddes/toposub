...
spath='/home/joel/data/greenlandprecipitation/gldata/'

startDate='1979-01-01 00:00:00' 	#yyyy-mmd-d h:m:s
...
#eraBoxEle<-getEraEle(dem=eraBoxEleDem, eraFile=infileT) # $masl
#gridEle<-rep(eraBoxEle[nbox],length(mf$id))
gridEle=extract(eraBoxEleDem,shp)
mf$gridEle<-gridEle
