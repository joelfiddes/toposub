...
SIMULATE=TRUE #should simulations occur (point method) or just setup of simulation directories (scf bias method)
...
swTopo==F
#=======================================================================================================
#			PARAMETERs specific scf method
#=======================================================================================================
#sequence of coarse grids to compute
nboxSeq=
scfseq=c(0.5,0.75,1,1.25,1.5,1.75,2,2.5,3)
#start=175297#"2006-10-01 UTC"
#end=192817#"2007-10-01 UTC"

#imis cut dates
start=1#"1996-10-01 UTC"
#start= 245425#"2010-10-01 UTC"
end=262945#"2011-10-01 UTC"
...
#=======================================================================================================
startDate='1996-09-01 00:00:00' 	#yyyy-mmd-d h:m:s
...
lcin=raster(paste(topoRoot,'/lc.tif',sep=''))
...
#tscale points mode specific
#mfin=paste(root,'/sim/_master/shp/IMIS_meta.txt',sep='')
#points_shp=shapefile(paste(root,'/sim/_master/shp/imisUTM.shp',sep=''))
mfin=paste(root,'/sim/_master/shp/sites_completeMeta.txt',sep='')

#shapefile of points in UTM + 'id', 'ele', 'slp', 'asp', 'svf'
points_shp=shapefile(paste(root,'/sim/_master/shp/gstSite_UTM_meta.shp',sep=''))
